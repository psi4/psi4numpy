...
def spin_block_tei(I):
    ...
    Using np.kron, we project I and I tranpose
    into the space of the 2x2 identity. The result is
    our two electron integral tensor in the spin orbital basis
    '''
...
# Get orbital energies, cast into NumPy array,
# and extend eigenvalues
