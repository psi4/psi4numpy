...
class HelperCCEnergy(object):
    ...
    def compute_energy(self, e_conv = 1e-7, r_conv=1e-7, maxiter=100, max_diis=8, start_diis=1):
        ...
        for CCSD_iter in range(1, maxiter + 1):
            ...
            print('CCSD Iteration %3d: CCSD correlation = %.15f   dE = % .5E   DIIS = %d' % (CCSD_iter, CCSDcorr_E, (CCSDcorr_E - CCSDcorr_E_old), diis_object.diis_size))
