"""
This script calculates nuclear Hessians of RHF using
derivative integrals obtained from PSI4
...
H_python = rhf_hessian(mol, options)
H_python_mat = psi4.core.Matrix.from_array(H_python)
