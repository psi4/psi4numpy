# A simple Psi 4 script to compute Molecular Dynamics Trajectories
...
# Molecular Dynamics Main Program
    ...
    for i in range(1,max_md_step+1):
        ...
        pos_new,vel_new,accel_new,energy_new = md_helper.integrator(int_alg,timestep,pos,veloc,molec,grad_method)
        pos = pos_new
        if (not opt):
            veloc = vel_new
        accel = accel_new
